    ...
    <label>
      Paper Title
        ...
        value='<?php echo $row123['ResearchTitle'];?>'>
              ...
              <label>
      Paper CO-Author
<select class="limitedNumbChosen" multiple="true" style="width: 450px; height: 30px; direction: ltr" dir="ltr" id="journalauthor" name="journalauthor">
...
<?php
  ...
  //Select2
    ...
    <label>
      Publication Year
<input type="number" min="1900" max="2099" step="1" value="2016"  id="journalyear" value="<?= $row123[7];?>"
...
<input type="number" min="0.0" max="1000" step="0.1" value="0"  id="IF" value='<?php echo $row123['8'];?>'/> 

   </label>
   
       <label>
      Volume (Publication Volume)
<input type="number" min="1" max="1000" step="1" value='<?php echo $row123['9'];?>'  id="vol" value='<?php echo $row123['9'];?>' /> 
    </label>
          
     <label>
      Issue (Publication Issue)
<input type="number" min="1" max="1000" step="1" value='<?php echo $row123['10'];?>' id="no"/> 
    </label>
   
        <label>
      Number of Pages
<input type="number" min="1" max="1000" step="1" value='<?php echo $row123['11'];?>'  id="pages" /> 
    </label>
   
        <label>
    Scientific Registeration Date
<input type="date" placeholder="14-11-1984"  id="sciregister" value='<?php echo $row123['4'];?>'> 
    </label>

         <label>
     Ethical Registeration Date
<input type="date" placeholder="14-11-1984"  id="ethical" value='<?php echo $row123['5'];?>'> 
    </label>
   
         <label>
     Ethical Registeration Number
<input type="text" placeholder="17/59/1234"  id="ethicalno" value='<?php echo $row123['16'];?>'> 
    </label>
    ...
    <label>
Country
 <select  class="limitedNumbChosen"style="width: 450px; height: 30px; direction: ltr" dir="ltr" id="country" name="country">
...
<option value="Zimbabwe">Zimbabwe</option>
      ...
      <input type="text" name="doi" placeholder="ICET/1254/ICETJ1" value='<?php echo $row123['13'];?>' id="doi">
    </label>
...
<option value="No">No</option>
  ...
  <fieldset class="account-action">
    <input class="btn" type="submit"  value="Insert Data" id="submit111"/>
    <button id="submit11" class="btn" name="submit1">Insert</button>
...
<button id="submit112" class="btn" name="submit1" type="submit">Insert</button>
  </fieldset>
  <?php
}
	?>
  ...
  <fieldset class="account-info">
   ...
   <h2>Journal Details Form Insertion</h2></legend>
    <label>
      Paper Title
        <input type="text" placeholder="ICET (Internation conference Electronical Technology)" id="papertitle" 
        value="<?php if (isset($_POST['id3'])){ echo $row123[3]; } ?>">
    </label>
...
<input type="date" placeholder="14-11-1984"  id="ethical"> 
         ...
         <label>
     Ethical Registeration Number
<input type="text" placeholder="17/59/1234"  id="ethicalno"> 
    </label>
...
function fromhide1(){
		$.ajax({
		url:"journal_insert.php",
		type:"POST",
		async:false,
		success:function(data){
		$('#t1').fadeOut('slow').load('journal11.php').fadeIn("slow");
