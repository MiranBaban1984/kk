...
{
 $query = "SELECT * FROM journals j, checkerinfo c where j.CheckerID=c.CheckerID and c.CheckerEmail="."'".$_SESSION['b']."'";
 ...
 if(mysqli_num_rows($result) > 0)
 {
  ...
  header('Content-Disposition: attachment; filename=Journal_Excel.xls');
  echo $output;
 }
}
?>