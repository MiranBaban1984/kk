...
if(in_array($fileextactual2,$allowed2)){
  ...
  if($fileerror2===0){
    ...
    if($filesize2 < (11*1024*1024)){
      ...
      $filedest2='uploadsPromotion/'.$filenamenew2;
...
$sql_insert_teacher="
insert into inters(TeacherName,ResearchTitle,RegisterationDate,ApprovalDate,
EthicalNumber,JournalName,PublishingYear,Impactfactor,Volume,Issue,Pages,place,DOI,Weblink,File,Ethics,Publisher,PaperType,indexing,Keyword,Teacher_ID,CheckerID,MainAuthor) values('$q5','$_POST[papertitle]','$_POST[sciregister]','$_POST[ethical]',
	...
	?>
		   ...
		   ?>
            <tbody id="table-body">
              <?php
				$i=0;
$sql_teacher_journal="Select * from inters where Teacher_ID=$row_teacher[0]";
            ...
            <tbody id="table-body">
              <?php
			   ...
			   if(isset($_POST['AuthorName'])){
				   $sql_select_journal="Select  * from inters js, teacherinfo ti, teacher t,checkerinfo ci
        ...
        $(function() {
		    $(".delete").click(function(e) {
                ...
                if (confirm("Sure you want to delete this post? This cannot be undone later.")) {
                    $.ajax({
                        type : "POST",
                        url : "inter_teacher_delete.php", //URL to the delete php script
                        data: ({
                        id: id
                    }),
                        success : function() {
...
.limitedNumbChosen, .limitedNumbSelect2{
  ...
  <form method="post" action="exportinternational.php">
       ...
       <table class="table table-bordered table-striped" id="table1" style="width: 100%;">
		   ...
		   ?>
            <tbody id="table-body">
              <?php
				$i=0;
$sql_teacher_journal="Select * from inters j, checkerinfo ch where j.CheckerID=ch.CheckerID and ch.CheckerEmail="."'".$_SESSION['b']."'";
$result_journal_data=mysqli_query($conn,$sql_teacher_journal) or die(mysqli_error($conn));	   
while ($row_teacher_data=mysqli_fetch_array($result_journal_data)){
		   ...
		   ?>
            <tbody id="table-body">
              <?php
			   ...
			   if(isset($_POST['AuthorName'])){
				   $sql_select_journal="Select * from inters j, checkerinfo ch where j.CheckerID=ch.CheckerID and ch.CheckerEmail="."'".$_SESSION['b']."' and MainAuthor like "."'%".$_POST['AuthorName']."%'";
			   }
			   
						   
			  else if(isset($_POST['RsearchTitle'])){
				   $sql_select_journal="Select * from inters j, checkerinfo ch where j.CheckerID=ch.CheckerID and ch.CheckerEmail="."'".$_SESSION['b']."' and ResearchTitle like "."'%".$_POST['RsearchTitle']."%'";

			   }
			   
			   elseif(isset($_POST['PublicationYear'])){
				   $sql_select_journal="Select * from inters j, checkerinfo ch where j.CheckerID=ch.CheckerID and ch.CheckerEmail="."'".$_SESSION['b']."' and PublishingYear= "."'".$_POST['PublicationYear']."'";
			   }
			   
			  elseif(isset($_POST['ImpactFactor'])){
				   $sql_select_journal="Select * from inters j, checkerinfo ch where j.CheckerID=ch.CheckerID and ch.CheckerEmail="."'".$_SESSION['b']."' and Impactfactor= "."'".$_POST['ImpactFactor']."'";
			   }


         else if(isset($_POST['multitext'])){
          $sql_select_journal="Select * from inters j, checkerinfo ch where j.CheckerID=ch.CheckerID and ch.CheckerEmail="."'".$_SESSION['b']."' and Keyword like "."'%".$_POST['multitext']."%'";

        }
			   
			   else{
	  $sql_select_journal="Select * from inters j, checkerinfo ch where j.CheckerID=ch.CheckerID and ch.CheckerEmail="."'".$_SESSION['b']."' and MainAuthor like "."'%".$_POST['AuthorName1']."%' and 
       ...
       <table class="table table-bordered table-striped" id="table1" style="width: 100%;">
		   ...
		   ?>
            <tbody id="table-body">
              <?php
				$i=0;
$sql_teacher_journal="Select * from inters";
$result_journal_data=mysqli_query($conn,$sql_teacher_journal) or die(mysqli_error($conn));	   
while ($row_teacher_data=mysqli_fetch_array($result_journal_data)){
		   ...
		   ?>
            <tbody id="table-body">
              <?php
			   ...
			   if(isset($_POST['AuthorName'])){
				   $sql_select_journal="Select * from inters  where MainAuthor like "."'%".$_POST['AuthorName']."%'";
			   }
			   
						   
			  else if(isset($_POST['RsearchTitle'])){
				   $sql_select_journal="Select * from inters where ResearchTitle like "."'%".$_POST['RsearchTitle']."%'";

			   }
			   
			   elseif(isset($_POST['PublicationYear'])){
				   $sql_select_journal="Select * from inters where PublishingYear= "."'".$_POST['PublicationYear']."'";
			   }
			   
			  elseif(isset($_POST['ImpactFactor'])){
				   $sql_select_journal="Select * from inters  where Impactfactor= "."'".$_POST['ImpactFactor']."'";
			   }


         else if(isset($_POST['multitext'])){
          $sql_select_journal="Select * from inters  where Keyword like "."'%".$_POST['multitext']."%'";

        }
			   
			   else{
	  $sql_select_journal="Select * from inters where MainAuthor like "."'%".$_POST['AuthorName1']."%' and 
	  PublishingYear= "."'".$_POST['year1']."'";
			   }
