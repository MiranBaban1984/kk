...
<body>
    ...
    <div style="width: 80%; margin: auto;"><canvas id="citationsChart"></canvas></div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            var chartData = {
                labels: <?php echo json_encode(array_keys($totalCitationsByDepartment)); ?>,
                datasets: [{
                    label: 'Total Citations by Department',
                    data: <?php echo json_encode(array_values($totalCitationsByDepartment)); ?>,
