...
<table align="center">
	<tr>
	  ...
	  <form id="loginForm" enctype="multipart/form-data" method="post" action="test.php">
  <fieldset class="account-info">
   <legend>
   <h2 align="center">School Manager Login Form</h2>
   </legend>
   <label>
     Email Address
  ...
  <fieldset class="account-action">
    <input class="btn" type="submit"  value="Insert Data" id="login"/>
