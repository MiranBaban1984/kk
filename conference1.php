   ...
   <h2>Conference Details Form Insertion</h2></legend>
    ...
    <label>
      Publisher Organization
       <input type="text" placeholder="IEEE" id="publisher" name="publisher"/>
    </label>
    
    <label>
      CO-Author
<select class="limitedNumbChosen" multiple="true" style="width: 450px; height: 30px; direction: ltr" dir="ltr" id="confauthor" name="confauthor"/>
   <?php
...
<?php
  ...
  //Select2
    ...
    <label>
      Conference Year
<input type="number" min="1900" max="2099" step="1" value="2016" id="year" name="year"/> 
   </label>
   
   
    <label>
      Conference Country
 <select name="country" class="limitedNumbChosen"style="width: 450px; height: 30px; direction: ltr" dir="ltr" id="country">
...
<option value="Zimbabwe">Zimbabwe</option>
    ...
    <label>
      ...
      <input type="text" name="title" placeholder="General Dentistry" id="title"/>
    </label>
                
    <label>
      Paper - DOI (Digital Object Identification)
      <input type="text" placeholder="ICET/1254/ICETJ1" name="doi" id="doi"/>
    </label>
...
e.preventDefault();
	...
	$("#confauthor :selected").each(function(i, selected){
		realvalues[i]=$(selected).val();
			});
    var name=$("#name").val();
    var publisher=$("#publisher").val();
   // var realvalues=$("#realvalues").val();
	var year=$("#year").val();
...
function fromhide1(){
		...
		async:false,
		success:function(data){
		$('#t1').fadeOut('slow').load('conference11.php').fadeIn("slow");
		fromhide2();
		}
	});
