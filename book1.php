...
<form  id="message11" name="loginForm" action="#">
  <fieldset class="account-info">
   <legend>
   <h2>Book Details Form Insertion</h2></legend>
    <label>
      Book Title
...
<label>
      CO-Author
<select class="limitedNumbChosen" multiple="true" style="width: 450px; height: 30px; direction: ltr" dir="ltr" id="bookauthor" name="bookauthor"/>
   <?php
...
<?php
  ...
  //Select2
    ...
    <label>
      Publication Year
<input type="number" min="1900" max="2099" step="1" value="2016" id="year"/> 
...
<option value="Zimbabwe">Zimbabwe</option>
  ...
  //Select2
    ...
    <label>
      ...
      <input type="text" name="publicationorganization" placeholder="Weily" id="publicationorganization"/>
    </label>
...
e.preventDefault();
	...
	$("#bookauthor :selected").each(function(i, selected){
...
function fromhide1(){
		...
		async:false,
		success:function(data){
		$('#t1').fadeOut('slow').load('book11.php').fadeIn("slow");
		fromhide2();
		}
	});
