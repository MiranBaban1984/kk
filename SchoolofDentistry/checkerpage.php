...
<section>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-sm-14 text-center"> 
      <a href="../checkerinfo.php">
      <img class="img-circle" alt="140x140" style="width: 140px; height: 140px;" src="../123.jpg" data-holder-rendered="true"/>
        <h3>Acount Info.</h3>
        <!-- <p>This is Commitee information.</p> -->
        </a>
      </div>
