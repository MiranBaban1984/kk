...
<section>
  ...
  <div class="container ">
    <div class="row">
      <div   align="center"> <img class="img-circle" alt="140x140" style="width: 140px; height: 140px;" src="img/register.gif" data-holder-rendered="true">
    ...
    <div class="row">
      ...
      <div class="col-xs-12">
        ...
        <div class="col-xs-12">
          ...
          <div class="col-xs-12">
            <input type="submit" name="submit_register" id="submit_register" value="Login">
